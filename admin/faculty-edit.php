...
$facultyMember = $faculty->getById($id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $department_id = isset($_POST['department_id']) && !empty($_POST['department_id']) 
        ? (int)$_POST['department_id'] 
        : (int)$facultyMember['department_id'];
    ...
    if (empty($error)) {
        if (isset($_FILES['photo']) && $_FILES['photo']['error'] === 0) {
            ...
            if ($uploadResult['success']) {
                if (!empty($facultyMember['photo_path']) && file_exists('../' . $facultyMember['photo_path'])) {
                    @unlink('../' . $facultyMember['photo_path']);
                }
        ...
        if (empty($error)) {
            if ($faculty->update($id, $data)) {
                header('Location: faculty-list.php?updated=1');
                exit();
            } else {
...
<head>
    ...
    <title>Edit Faculty - GyanPeeth College</title>
...
<body>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="department_id" name="department_id" required>
                                        ...
                                        <option value="<?php echo $dept['id']; ?>" 
                                                <?php echo (isset($facultyMember['department_id']) && $facultyMember['department_id'] == $dept['id']) ? 'selected' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" 
                                           value="<?php echo htmlspecialchars($facultyMember['name'] ?? ''); ?>" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="designation" name="designation" 
                                           value="<?php echo htmlspecialchars($facultyMember['designation'] ?? ''); ?>"
                                           required maxlength="200"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="qualification" name="qualification" 
                                           value="<?php echo htmlspecialchars($facultyMember['qualification'] ?? ''); ?>"
                                           maxlength="500"
                                           placeholder="e.g., Ph.D. in Economics">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="email" name="email" 
                                           value="<?php echo htmlspecialchars($facultyMember['email'] ?? ''); ?>"
                                           maxlength="200">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" 
                                           value="<?php echo htmlspecialchars($facultyMember['phone'] ?? ''); ?>"
                                           maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if (!empty($facultyMember['photo_path'])): ?>
                                <div class="mb-3">
                                    <label class="form-label">Current Photo</label>
                                    <div>
                                        <img src="../<?php echo htmlspecialchars($facultyMember['photo_path']); ?>" 
                                             alt="Faculty Photo" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Leave empty to keep current photo. Max size: 5MB</small>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="bio" class="form-label">Bio / About</label>
                                    <textarea class="form-control" id="bio" name="bio" rows="3"><?php echo htmlspecialchars($facultyMember['bio'] ?? ''); ?></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="joining_date" name="joining_date"
                                           value="<?php echo $facultyMember['joining_date'] ?? ''; ?>">
                                    <small class="text-muted">Date when faculty joined the college</small>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="leave_date" class="form-label">Leave/Retirement Date</label>
                                    <input type="date" class="form-control" id="leave_date" name="leave_date"
                                           value="<?php echo $facultyMember['leave_date'] ?? ''; ?>">
                                    <small class="text-muted">Set this when marking faculty as inactive/retired</small>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="display_order" class="form-label">Display Order</label>
                                    <input type="number" class="form-control" id="display_order" name="display_order" 
                                           value="<?php echo $facultyMember['display_order'] ?? 0; ?>" min="0">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                               <?php echo (isset($facultyMember['is_active']) && $facultyMember['is_active']) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="is_active">
                                            <strong>Active Faculty Member</strong>
                                        </label>
                                    </div>
                                    <small class="text-muted">Uncheck to mark as retired/inactive (will not show on public website)</small>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.getElementById('is_active').addEventListener('change', function() {
            ...
            if (!this.checked && !leaveDateField.value) {
