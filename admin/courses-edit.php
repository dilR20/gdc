...
$departments = $departmentModel->getAll(true); // Only active departments
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['department_id'])) {
        ...
        if ($courseModel->update($course_id, $data)) {
            $auth->logActivity($auth->getAdminId(), 'UPDATE_COURSE', 'Updated course: ' . $data['course_name']);
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="department_id" name="department_id" required>
                                        ...
                                        <option value="<?php echo $dept['id']; ?>" 
                                                <?php echo ($dept['id'] == $_POST['department_id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="seat_capacity" name="seat_capacity" 
                                           value="<?php echo htmlspecialchars($_POST['seat_capacity'] ?? ''); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3"
                                              placeholder="Brief description about the course"><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                                </div>
